 ...
 <footer class="tm-footer">
                ...
                <p class="tm-copyright-text">Copyright &copy; <span class="tm-copyright-year"><?php echo get_theme_mod('custom_theme_title_setting');?></span> Your Company 
        ...
        <div class="container">
         ...
         <div class="container-fluid js-tm-page-content" style="background:white;min-height:auto;min-height:auto;margin-bottom:30px;" >
             <?php
